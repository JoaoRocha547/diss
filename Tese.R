...
#### Simulation Study part2: Obtenção de mm amostras de cada tc Mãe ####
# e
#### Simulation Study part3: Obtenção dos IC bootstrap para cada tc Mãe ####
# Para cada das m tc geradas, aplicar o boot para obter, para um dos
# 3 tipos (basic,bca, perc), M IC bootstrap
# No final do ciclo "for", os valores das medidas de associação,
# e correspondentes M*m IC gerados são colocados num ficheiro txt
