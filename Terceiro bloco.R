...
#### Proporções médias e probabilidades de cobertura ####
...
#apply(ProbC,1,mean)
plot(1:30,apply(ProbC,1,mean), main="Medida V - Método Percentile", xlab="Tabelas Mãe", ylab="Proporções",
...
#apply(ProbC,1,mean)
plot(1:30,apply(ProbC,1,mean),  main="Medida V - Método BCa", xlab="Tabelas Mãe", ylab="Proporções",
     xlim=c(1,30), ylim=c(0, 100)) 
abline(h=95, col="black")
mean(apply(ProbC,1,mean))
...
#apply(ProbC,1,mean)
plot(1:30,apply(ProbC,1,mean),  main="Medida V - Método Basic", xlab="Tabelas Mãe", ylab="Proporções",
     xlim=c(1,30), ylim=c(0, 100))
abline(h=95, col="black")
mean(apply(ProbC,1,mean))
...
#apply(ProbC,1,mean)
plot(1:30,apply(ProbC,1,mean), main="Medida Vtilde - Método Percentile", xlab="Tabelas Mãe", ylab="Proporções",
     xlim=c(1,30), ylim=c(0, 100)) 
abline(h=95, col="black")
...
#apply(ProbC,1,mean)
plot(1:30,apply(ProbC,1,mean), main="Medida Vtilde - Método BCa", xlab="Tabelas Mãe", ylab="Proporções",
     xlim=c(1,30), ylim=c(0, 100))  
abline(h=95, col="black")
mean(apply(ProbC,1,mean))
...
#apply(ProbC,1,mean)
plot(1:30,apply(ProbC,1,mean), main="Medida Vtilde - Método Basic", xlab="Tabelas Mãe", ylab="Proporções",
     xlim=c(1,30), ylim=c(0, 100)) 
abline(h=95, col="black")
mean(apply(ProbC,1,mean))
...
#apply(ProbC,1,mean)
plot(1:30,apply(ProbC,1,mean), main="Medida W - Método Percentile", xlab="Tabelas Mãe", ylab="Proporções",
     xlim=c(1,30), ylim=c(0, 100)) 
abline(h=95, col="black")
mean(apply(ProbC,1,mean))
...
#apply(ProbC,1,mean)
plot(1:30,apply(ProbC,1,mean), main="Medida W - Método BCa", xlab="Tabelas Mãe", ylab="Proporções",
     xlim=c(1,30), ylim=c(0, 100)) 
abline(h=95, col="black")
mean(apply(ProbC,1,mean))
...
#apply(ProbC,1,mean)
plot(1:30,apply(ProbC,1,mean), main="Medida W - Método Basic", xlab="Tabelas Mãe", ylab="Proporções",
     xlim=c(1,30), ylim=c(0, 100)) 
abline(h=95, col="black")
mean(apply(ProbC,1,mean))
